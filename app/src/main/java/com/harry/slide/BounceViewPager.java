...
public class BounceViewPager extends ViewPager {
     ...
     */
    final static int DEFAULT_OVERSCROLL_TRANSLATION = 540;

    /**
     * duration of overscroll animation in ms
     */
    final private static int DEFAULT_OVERSCROLL_ANIMATION_DURATION = 1000;
    ...
    private void init(AttributeSet attrs) {
        ...
        mOverscrollTranslation = a.getDimension(R.styleable.BounceViewPager_overscroll_translation,
            DEFAULT_OVERSCROLL_TRANSLATION);
        mOverscrollAnimationDuration = a.getInt(R.styleable.BounceViewPager_overscroll_animation_duration,
    ...
    protected boolean getChildStaticTransformation(View child, Transformation t) {
        ...
        if (mOverscrollEffect.isOverscrolling() && isFirstOrLast) {
            ...
            t.getMatrix().reset();
            final float translateX = (float) mOverscrollTranslation * (mOverscrollEffect.mOverscroll > 0 ? Math.min(
                mOverscrollEffect.mOverscroll, 1) : Math.max(mOverscrollEffect.mOverscroll, -1));
            mCamera.save();
